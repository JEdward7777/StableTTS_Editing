...
class StableTTSAPI(nn.Module):
    ...
    def inference(self, text, ref_audio, language, step, temperature=1.0, length_scale=1.0, solver=None, cfg=3.0, prefix=None, postfix=None,
        ...
        # Accept either file paths (str) or pre-computed mel tensors (torch.Tensor)
        # This allows the MAS alignment pipeline to pass mel tensors directly,
        # avoiding redundant audio loading and mel extraction.
